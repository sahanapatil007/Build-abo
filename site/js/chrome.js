(function () {
  const BLOG = "../demo.7iquid.com/alsha/blog/index.html";
  const MAP =
    "https://www.google.com/maps/search/?api=1&query=3rd+Floor+44+Main+Rd+Kallumantapa+Horamavu+Bengaluru+560113";
  const MENU_ICON =
  ...
  function logo() {
    return (
      '<a href="index.html" class="logo" aria-label="buildabo — House Construction and Interiors">' +
  ...
  function footerHTML() {
    return (
      ...
      '<p class="mt-3 max-w-md">buildabo is a residential construction company in Bangalore — home construction and home interior designers from foundation to final finish.</p>' +
      "</div></div>" +
      ...
      '<p class="mb-4"><a href="' +
      MAP +
      '">3rd Floor, 44 Main Rd,<br />Kallumantapa, Horamavu,<br />Bengaluru, Karnataka 560113</a></p>' +
